...
if __name__ == "__main__":
    ...
    train_df = pd.read_csv(root_path+"meta/train/train_common.tsv", delimiter="\t")
    eval_df = pd.read_csv(root_path+"meta/test/eval_common.tsv", delimiter="\t")

    train_new = rm_intersec(train_df)
    train_new.to_csv(root_path+"meta/train/train_rm_intersect.tsv", index=False, sep="\t")
    eval_new = rm_intersec(eval_df)
    eval_new.to_csv(root_path+"meta/test/eval_rm_intersect.tsv", index=False, sep="\t")