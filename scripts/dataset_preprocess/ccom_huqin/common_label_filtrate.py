...
if __name__ == "__main__":
    ...
    train_meta = pd.read_csv(root_path+"meta/train/train.tsv",sep="\t")
    eval_meta = pd.read_csv(root_path+"meta/test/eval.tsv",sep="\t")
    ...
    with open(root_path+"meta/common_labels.txt", "w") as f:
        f.write("\n".join(common_labels))
    ...
    train_meta_filt.to_csv(root_path+"meta/train/train_common.tsv", index=False, sep="\t")
    eval_meta_filt.to_csv(root_path+"meta/test/eval_common.tsv", index=False, sep="\t")